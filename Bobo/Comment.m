...
- (instancetype)initWithDictionary:(NSDictionary *)dictionary
{
    ...
    if (self) {
        ...
        _heightForMessageCell = cBigGap+cAvatarHeight+cBigGap+[Utils heightForString:_text width:mTextWidth fontSize:cTextFontSize]+cBigGap+[Utils heightForString:_status.text width:mTextWidth fontSize:cTextFontSize]+cSmallGap;
    }
    return self;
}
